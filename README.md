...
For creating a message catalog, you download a template with all English messages from [here](https://github.com/peter88213/novelyst_collection/blob/main/i18n/messages.pot). 
...
Name the binary file **novelyst_collection.mo**. 


### Install your translation for testing

Add a subdirectory tree to **novelyst/locale**, and place *novelyst_collection.mo* there, like this:
...
**HINT:** *novelyst_collection* comes with German translations. Look at the `de` directory tree, if you need an example. 
...
This is Open Source software, and the *novelyis licensedon* plugin is licenced under GPLv3. See the
