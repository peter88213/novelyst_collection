...
[Download the latest release (version 4.3.3)](https://github.com/peter88213/novelyst_collection/raw/main/dist/novelyst_collection_v4.3.3.zip)

- Unzip the downloaded zipfile "novelyst_collection_v4.3.3.zip" into a new folder.
