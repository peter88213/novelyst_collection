...
[Download the latest release (version 5.0.4)](https://github.com/peter88213/novelyst_collection/raw/main/dist/novelyst_collection_v5.0.4.zip)

- Extract the "novelyst_collection_v5.0.4" folder from the downloaded zipfile "novelyst_collection_v5.0.4.zip".
