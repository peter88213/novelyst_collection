...
[Download the latest release (version 4.3.7)](https://github.com/peter88213/novelyst_collection/raw/main/dist/novelyst_collection_v4.3.7.zip)

- Extract the "novelyst_collection_v4.3.7" folder from the downloaded zipfile "novelyst_collection_v4.3.7.zip".
