...
[Download the latest release (version 0.4.1)](https://github.com/peter88213/novelyst_collection/raw/main/dist/novelyst_collection_v0.4.1.zip)

- Unzip the downloaded zipfile "novelyst_collection_v0.4.1.zip" into a new folder.
