...
[Download the latest release (version 4.0.5)](https://github.com/peter88213/novelyst_collection/raw/main/dist/novelyst_collection_v4.0.5.zip)

- Unzip the downloaded zipfile "novelyst_collection_v4.0.5.zip" into a new folder.
