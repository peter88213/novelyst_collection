...
- [noveltree](https://peter88213.github.io/noveltree/) version 4.19+

## Download and install

[Download the latest release (version 0.99.0)](https://github.com/peter88213/noveltree_collection/raw/main/dist/noveltree_collection_v0.99.0.zip)

- Extract the "noveltree_collection_v0.99.0" folder from the downloaded zipfile "noveltree_collection_v0.99.0.zip".
